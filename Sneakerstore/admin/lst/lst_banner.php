...
?>
	...
	<div class="base-lista">
		...
		<h2>Banners</h2>
		<a href="index.php?link=14">Inserir Banner</a>
		<p class="limpar">&nbsp;</p>
		
		<?php
      if(@$pesq !=""){
        $sql1 = "SELECT id_banner FROM banner WHERE $campo LIKE '%$pesq%'";
        $sql2 = "SELECT * FROM banner WHERE $campo LIKE '%$pesq%'";

        $complemento = "&pesq = $pesq&campo=$campo";
      }else{
        $sql1 = "SELECT id_banner FROM banner";
    ...
    ?>
        ...
        <?php
            ...
            $banners = selecionar($sql2." LIMIT $inicio, $lpp");
            $i=1;
        ...
        ?>
		  <tr class="<?php echo $col; ?>" align="center">
            ...
            <td><?php echo $banner["ativo"] ?></td>
            <td align="center"><a href="index.php?link=14&acao=Alterar&id=<?php echo $banner["id_banner"] ?>">Editar</a></td>
            <td align="center"><a href="index.php?link=14&acao=Excluir&id=<?php echo $banner["id_banner"] ?>" class="excluir">Excluir</a></td>
        </tr>
            <?php }} ?>
		...
		<div class="cx-paginacao">
			<p><?php echo mostraPaginacao("index.php?link=13$complemento", $ordem, $lpp, $total) ?></p>
		</div>
